...
# Stručně řečeno, JWT se používají jako bezpečný způsob ověřování uživatelů a sdílení informací.
# K podpisu JWT obvykle vydavatel používá soukromý klíč nebo tajný klíč.
# Příjemce JWT ověří podpis, aby zajistil, že token nebyl změněn poté, co byl podepsán vydavatelem.
...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///db.sqlite' # vytvoření sqlalchemy databáze

db = SQLAlchemy(app)

class Task(db.Model): # definování třídy Task a definice potřebných atributů
